...
int main(int argc, char* argv[]) {
    ...
    std::tuple<std::vector<std::string>, std::vector<std::vector<double>>, std::vector<double>> tuple_contents = data_handler.processData(training_data, categorical_indexes);
